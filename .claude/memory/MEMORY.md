...
- [Progress Log](progress_log.md) — done vs not-yet-built feature checklist
- [Next Steps](next_steps.md) — ordered feature queue: WPS flag → macwatch → BLE GATT → LoRa → BadUSB
