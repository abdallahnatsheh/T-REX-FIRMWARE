...
- [Progress Log](progress_log.md) — done vs not-yet-built feature checklist; last session 2026-05-25: lock-screen write-lock + auto-redraw on unlock; backspace hold-repeat; wifi/clock/statusbar bug fixes
